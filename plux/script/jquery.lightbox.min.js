...
if(d>g[1]-f*2-a.shrinkPadding){d=g[1]-f*2-a.shrinkPadding;c=d*j}if(c>g[0]-a.shrinkPadding){c=g[0]-a.shrinkPadding;d=c/j}}g=c+a.containerBorderSize*2;f=d+a.containerBorderSize*2;e-=g;h-=f;b("#lightbox-container-image-box").animate({width:g,height:f},a.containerResizeSpeed,function(){s()});if(e==0&&h==0)b.browser.msie?o(250):o(100);b("#lightbox-container-image-data-box").css({width:c+20});b("#lightbox-nav-btnPrev,#lightbox-nav-btnNext").css({height:d+a.containerBorderSize*2})}function s(){b("#lightbox-loading").hide();
